...
con.connect((err) => {
    if (err) throw err;
    console.log("Forbindelse til database oprettet!");
});
...
bot.on('message', async message => {
    ...
    if (commandfile) commandfile.run(bot, message, args, con); // Hvis det er en kommando fra ekstern mappe skal den bruges alligevel
})
